...
#define STRING_CONFIG_H_AUTHOR "(yevhenii, ender3x)" // Who made the changes.
...
#define MACHINE_UUID "8f557319-92c9-46fd-8af9-d82945f5feb8"
...
#define HEATER_0_MAXTEMP 295 /* actual is HEATER_n_MAXTEMP - 15 in menu_tune.cpp*/
 ...
 */
  ...
  #define JUNCTION_DEVIATION_MM 0.08 // (mm) Distance from real junction edge //Ender 3x
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -47, -8.7, 0 }
